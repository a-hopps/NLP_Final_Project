...
from app_src.OneVsAllMultiHeadEditorialTransformerWrapper import OneVsAllMultiHeadEditorialTransformerWrapper
...
class OneVsAllMultiHeadEditorialTransformerEvaluator():
    ...
    def evaluate_model(self, epochs, batch_size, number_of_tags=5, model=None, transformer_model_path=None, train_dataset_path=None, val_dataset_path=None, test_dataset_path=None):
        if model is None:
            ...
            transformer_wrapper = OneVsAllMultiHeadEditorialTransformerWrapper(model, number_of_tags)
